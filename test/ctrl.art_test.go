...
func TestArticleUnauthenticated(t *testing.T) {
	...
	r.GET("/article/view/:article_id", ctrls.GetArticle)
...
func TestArticleCreationPageAuthenticated(t *testing.T) {
	...
	r.GET("/article/create", middlewares.EnsureLoggedIn(), ctrls.ShowArticleCreationPage)
...
func TestArticleCreationAuthenticated(t *testing.T) {
	...
	r.POST("/article/create", middlewares.EnsureLoggedIn(), ctrls.CreateArticle)
